					...
					<div class="addnasabah-item form-row mb-4" style="padding-right: 2px;">
						<div class="col-6">
							<div class="input-group">
								...
								<input type="text" class="form-control px-2" id="rt" name="rt" autocomplete="off" placeholder="RT: 01">
							</div>
							<small
								id="rt-error"
								class="text-danger"></small>
						...
						<div class="col-6">
							<div class="input-group">
								...
								<input type="text" class="form-control px-2" id="rw" name="rw" autocomplete="off" placeholder="RW: 01">
							</div>
							<small
								id="rw-error"
								class="text-danger"></small>
