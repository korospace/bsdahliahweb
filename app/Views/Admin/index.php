					...
					<div class="card">
						<div class="card-body p-3">
							<div class="row" style="font-family: 'qc-medium';">
								<div class="col-8 d-flex align-items-center">
									<div class="numbers">
										<p class="text-sm mb-0 text-capitalize font-weight-bold">Saldo Bank</p>
										<h5 id="sampah-kertas" class="font-weight-bolder mb-0">
											Rp <span id="saldo-bank">0</span>
										</h5>
									</div>
								</div>
								<div class="col-4 text-end">
					...
					<div class="card">
						<div class="card-body p-3">
							<div class="row" style="font-family: 'qc-medium';">
								<div class="col-8 d-flex align-items-center">
									<div class="numbers">
										<p class="text-sm mb-0 text-capitalize font-weight-bold">Saldo Nasabah</p>
										<h5 id="sampah-kertas" class="font-weight-bolder mb-0">
											Rp <span id="saldo-nasabah">0</span>
										</h5>
									</div>
								</div>
								<div class="col-4 text-end">
