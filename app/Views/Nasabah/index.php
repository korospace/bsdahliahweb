				...
				<div class="container-fluid py-1 px-3" style="font-family: 'qc-semibold';">
					<nav aria-label="breadcrumb">
						<ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
							<li class="breadcrumb-item" style="font-size: 12px;"><a class="opacity-5 text-dark" href="javascript:;">Pages</a></li>
							<li class="breadcrumb-item text-dark active" style="font-size: 12px;" aria-current="page">Dashboard</li>
						</ol>
						<h6 id="nama-lengkap" class="font-weight-bolder mt-2 mb-0 text-capitalize" style="font-size: 16px;">
							_ _ _ _
						</h6>
						<div class="mt-2 text-sm">
							<i class="fas fa-money-bill-wave-alt" style="margin-right: 6px;"></i>
							<span id="saldo-uang">_ _</span>
						</div>
					</nav>
